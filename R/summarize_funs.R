...
summarize_db <-
        function(conn,
                ...
                schema_info <- dplyr::bind_rows(schema_info)
                ...
                for (i in 1:nrow(schemaInfo)) {
                        ...
                        schema <- schema_info$table_schema[i]
                        table_name <- schema_info$table_name[i]
                        field_name <- schema_info$column_name[i]
